...
def create_default_recipe(user):
    ...
    demo_recipe = Recipe(
        ...
        recipe_desc=("This is a demonstration recipe, to show a rough idea of "
                     "possible uses. \r\n"
                    "\r\n"
                    "Images can be clicked on to see a larger copy, this will "
                    "also allow you to open the full sized version of the image "
                    "in a new window"
                    )
    )
    ...
    stage2 = RecipeStage(
        stage_num=2,
        instructions="This stage has a user uploaded image with the image "
        "description being used as the images alt text.",
        is_final_stage=False
    )
    ...
    stage3 = RecipeStage(
        ...
        instructions=(
            ...
            "placeholder for the recipe - ideally showing what the end results "
            "of the recipe should look like. \r\n"
            "\r\n"
            "Recipes can have a nearly infinite number of stages to allow for "
            "some very complex recipes to be created."
        ),
        is_final_stage=True
    )
